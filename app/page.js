...
export default function TaskFlow() {
  ...
  if (!user) return <div style={{ padding: '50px', textAlign: 'center', fontFamily: 'sans-serif' }}>Oturum kontrol ediliyor...</div>;

  return (
    <div style={{ padding: '40px 20px', backgroundColor: '#f8fafc', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1000px', margin: '0 auto 50px' }}>
